...
?>
<title><?= $lang["schedule"]["title"] ?> | <?= $config["name"] ?></title>
<h3><?= $lang["schedule"]["sunday"] ?> <?php if(date("D")=="Sun") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["monday"] ?> <?php if(date("D")=="Mon") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["tuesday"] ?> <?php if(date("D")=="Tue") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["wednesday"] ?> <?php if(date("D")=="Wed") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["thursday"] ?> <?php if(date("D")=="Thu") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["friday"] ?> <?php if(date("D")=="Fri") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
?>
<hr>
<h3><?= $lang["schedule"]["saturday"] ?> <?php if(date("D")=="Sat") { ?><small style="color:blue">- <?= $lang["schedule"]["today"] ?></small><?php } ?></h3>
<?php
...
<p class="text-center"><a href="<?= $config["url"] ?>sys/schedule"><?= glyph("cog",$lang["schedule"]["edit"]) ?> <?= $lang["schedule"]["edit"] ?></a></p>
<?php } ?>
