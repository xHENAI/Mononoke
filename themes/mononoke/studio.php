<div class="wrapper">
    <div class="postbody">
        <div class="newseason">
            <h1><?= $lang["studio"] . ": " . $studio->getName() ?></h1>
            <div class="listseries">
                ...
                <?php } ?>
                <div class="hpage">
                    <a href="<?= $config["url"] ?>studio/<?= $studio->getSlug() ?>/page/1" class="r"><i class="fas fa-angle-left" aria-hidden="true"></i><i class="fas fa-angle-left" aria-hidden="true"></i> <?= $lang["first"] ?></a>
                    <a href="<?= $config["url"] ?>studio/<?= $studio->getSlug() ?>/page/<?= $prev_page ?>" class="r"><i class="fas fa-angle-left" aria-hidden="true"></i> <?= $lang["prev"] ?></a>
                    <a class="r"><?= "Page " . $pagination . " of " . $total_pages ?></a>
                    <a href="<?= $config["url"] ?>studio/<?= $studio->getSlug() ?>/page/<?= $next_page ?>" class="r"><?= $lang["next"] ?> <i class="fas fa-angle-right" aria-hidden="true"></i></a>
                    <a href="<?= $config["url"] ?>studio/<?= $studio->getSlug() ?>/page/<?= $total_pages ?>" class="r"><?= $lang["last"] ?> <i class="fas fa-angle-right" aria-hidden="true"></i><i class="fas fa-angle-right" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
    </div>